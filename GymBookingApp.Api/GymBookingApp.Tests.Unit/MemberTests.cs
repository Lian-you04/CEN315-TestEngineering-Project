...
public class MemberTests
{
    ...
    public async Task GetAllMembersAsync_ShouldReturnAllMembers()
    {
        ...
        var members = new List<Member> { new Member { Id = 1, Name = "Dahir" } };
        var mockRepo = new Mock<IMemberRepository>();
    ...
    public async Task GetAllMembersAsync_ShouldReturnListOfMembers()
    {
        ...
        var mockMembers = new List<Member> { new Member { Id = 1, Name = "Dahir" } };
        var mockRepo = new Mock<IMemberRepository>();
        mockRepo.Setup(r => r.GetAllAsync()).ReturnsAsync(mockMembers);
        var service = new MemberService(mockRepo.Object);
        ...
        Assert.Single(result);
        Assert.Contains(result, m => m.Name == "Dahir");
    }
}